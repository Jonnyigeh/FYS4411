    ...
    def run_optimizer(self):
        ...
        with tqdm(total=self.n_cycles,
            ...
            for n in range(self.n_cycles):
                ...
                res, energies, spin_configs, E_grad_a, E_grad_b, E_grad_W = self.sampler.sampler(
                ...
                W, a, b = self.update_parameters(W_grad=np.array(E_grad_W),
                ...
                pbar.set_description(
                    rf"[Optimization progress, E = {E_loc:.4e}]"
                )
                pbar.update(1)
